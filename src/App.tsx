...
const DailyReport: FC<Readonly<{ weatherInfo: WeatherInfo }>> = ({
  ...
  <details>
    <summary style={{ cursor: 'pointer' }}>7 Days Weather Report</summary>
        ...
        ({ time, description, imageUrl, temperature }, idx) => (
          <li key={idx}>
            ...
            >
              ...
              <img src={imageUrl} style={{ width: '38px', height: '38px' }} />
              <p style={{ margin: 0, width: '60px' }}>{description}</p>
              <p style={{ margin: 0 }}>
                {temperature.max}
    ...
    <>
      ...
      >
        {weatherInfo && (
          ...
          >
            <LocationForm handleSubmit={setCity} />
